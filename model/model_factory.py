...
def get_model(model_name, num_classes):
    ...
    if model_name in CUSTOM_MODELS:
        ...
        model = CUSTOM_MODELS[model_name](num_classes=num_classes,medicalnet_pretrained_path='./pretrained/medicalnet_resnet50.pth',raddino_pretrained_path='./pretrained/rad_dino_base.safetensors')
    else:
